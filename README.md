...
- 권소정 : UX/UI 설계, 실시간 매칭 페이지, 영상 제작
- 이지영 : UX/UI 설계, 회원관리 및 실시간 채팅 페이지, 회의록 작성
- 차영범 : 기획 및 UX/UI 설계, 실시간 운동 모임 페이지, 로그인, 실시간 알림, 채팅, 랭킹, 비동기 데이터 처리, 발표


**Backend**

- 신창학 : 실시간 채팅
- 정현모 : DB설계 및 구축, 운동 모임, 팀 통계/매칭, PPT 제작
- 박기현 : 아키덱쳐 설계, CI/CD 및 MSA 아키텍처 구축, OAUTH 소셜 로그인, 회원 관리, Hybrid App 개발
