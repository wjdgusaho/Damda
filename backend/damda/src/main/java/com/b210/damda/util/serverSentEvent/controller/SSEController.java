...
import com.b210.damda.util.serverSentEvent.service.EventListService;
...
//        eventStreamService.disconnectStream(eventListService.getUserNo());
    ...
    // 이벤트 발송 예제, 테스트 이벤트
    @GetMapping(value = "/sse/login/testEvent", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    public void testEvent() {
        eventListService.testEvent();
    }

    // 이벤트 발송 예제, 테스트 이벤트
    @GetMapping(value = "/sse/login/friendEvent", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
