...
export const ChangePassword = function () {
    ...
    useEffect(() => {
        if (!checkPassword) {
            setPasswordHelp('비밀번호는 최소 5자 이상, 최대 15자 미만의 특수문자를 제외한 영문, 숫자 조합입니다.')
    ...
    function handleCheckPasswordChange(event: React.ChangeEvent<HTMLInputElement>) {
        ...
        <Box style={{ color: '#CFD4EE' }}>
            ...
            {!change && (
                <div style={{ marginLeft: 'auto', marginRight: 'auto' }}>
                    <p>
                        <span className="text-lilac-500">가입시 등록하신 이메일</span>로 <br /> 비밀번호를 재설정합니다.
                    </p>
